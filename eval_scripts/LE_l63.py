...
def step(states, dt):
    ...
    states[0] = solve_ivp(lorenz63, (0, dt), states[0], t_eval=t_eval, method='DOP853', rtol=1e-9, atol=1e-12).y[:,-1]
    states[1] = solve_ivp(lorenz63, (0, dt), states[1], t_eval=t_eval, method='DOP853', rtol=1e-9, atol=1e-12).y[:,-1]
    return states
