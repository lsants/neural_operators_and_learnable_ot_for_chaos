...
import matplotlib.pyplot as plt
from l63 import generate_l63_data, lorenz63
...
if __name__ == "__main__":
    ...
    data_folder, random_index = 'F_50_dt10', 0
    args.num_of_sample = 50
        ...
        for i in tqdm(range(0, int(args.num_of_sample/num))):
            ...
            for j in range(0,split):
                ...
                with Pool(n_workers) as pool:
                        total_traj = np.array(pool.map(generate_l63_data, params_cat_seed))
    ...
    data_folder, random_index = 'F_10_dt10_validation', 5000
    args.num_of_sample = 10
    os.makedirs(data_folder, exist_ok = True)
    ...
    data_folder, random_index = 'F_10_dt10_test', 10000
    args.num_of_sample = 10
    os.makedirs(data_folder, exist_ok = True)
